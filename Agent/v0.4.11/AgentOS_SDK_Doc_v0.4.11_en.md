# AgentOS SDK for APK V0.4.11 Documentation

## 📋 Version Information

![SDK](https://img.shields.io/badge/SDK_Version-v0.4.11-blue)
...
```Groovy
dependencies {
        implementation 'com.orionstar.agent:sdk:0.4.11-SNAPSHOT' // IMPORTANT: Agent SDK dependency
